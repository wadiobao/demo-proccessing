...
import com.example.demo.mongo.service.quiz.FileGenerationService;
import com.example.demo.mongo.service.quiz.GeminiAIService;
import com.example.demo.mongo.service.quiz.GeminiAIService.GeminiResponse;
...
public class QuizService implements IQuizService {
	...
	private String wordPath;
	 ...
	 final FileGenerationService fileGenerationService;	
	 final ArchivedQuestionService archivedQuestionService;	
	 final IUserResourceService iUserResourceService;
	 final FileBasedKeywordExtractor basedKeywordExtractor;
	 final GeneralUtils generalUtils;
	 final IContentService iContentService;
