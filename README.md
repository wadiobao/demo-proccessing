...
> **Lưu ý:** Tesseract OCR và language pack tiếng Việt (	esseract-ocr-vie) được cài tự động trong quá trình build Docker image.
...
| MAIL_USERNAME / MAIL_PASSWORD | SMTP Gmail | pp@gmail.com / app password |
